...
namespace GestionDeInventario.Controllers
{
    public class ProveedoresController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ProveedorId,Nombre,Direccion,Telefono,Email")] ProveedoresModels proveedoresModels)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ProveedorId,Nombre,Direccion,Telefono,Email")] ProveedoresModels proveedoresModels)
        {
            if (id != proveedoresModels.ProveedorId)
            {
                return NotFound();
            }
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                    if (!ProveedoresModelsExists(proveedoresModels.ProveedorId))
                    {
                        return NotFound();
                    }
                    else
